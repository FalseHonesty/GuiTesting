...
public class GlyphCache
{
    ...
    private void allocateGlyphCacheTexture()
    {
        ...
        ReflectionHelper.setPrivateValue(AbstractTexture.class, textureObj, this.textureName, "glTextureId", "field_110553_a");
        //textureObj.glTextureId = this.textureName;
        Map<ResourceLocation, ITextureObject> map = ReflectionHelper.getPrivateValue(TextureManager.class, Minecraft.getMinecraft().getTextureManager(),
                "mapTextureObjects", "field_110585_a");
        map.put(this.texture, textureObj);
